...
class _DashboardScreenState extends State<DashboardScreen> {
  // Data dummy habits (menggunakan setState untuk CRUD)
  List<Habit> habits = [
    Habit(
      id: '1',
  ...
  // Fungsi untuk menambah habit baru
  ...
  void _updateHabit(String id, Habit updatedHabit) {
    setState(() {
  ...
  void _toggleCompleted(String id) {
    setState(() {
      int index = habits.indexWhere((habit) => habit.id == id);
      if (index != -1) {
        habits[index].toggleCompleted();
      }
    });
  }

  // Navigasi ke Add Habit Screen
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: GestureDetector(
          onTap: () => _toggleCompleted(habit.id),
          child: Container(
            width: 50,
            height: 50,
            decoration: BoxDecoration(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.category_outlined, size: 14, color: AppColors.grey),
